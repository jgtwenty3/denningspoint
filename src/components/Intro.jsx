  ...
  return (
    <div className = "mb-20">
      <div className="flex flex-wrap justify-center items-center mt-8 space-x-4 space-y-4"> 
       ...
       <div ref={contentRef} className="flex flex-col items-center justify-center bg-white bg-opacity-90 p-6 md:p-12 rounded-lg  mt-10  max-w-4xl mx-auto"> 
          <h1 className="font-josefin text-3xl md:text-4xl font-bold text-black text-center mb-4"> 
          ...
          <p className="font-josefin text-base md:text-lg text-black text-center leading-relaxed">
